...
<!-- favicon -->
<link rel="icon" type="image/x-icon" href="Assets/img/crm.ico">
  ...
  <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <?php  if($_SESSION['Tipo_Usuario'] != "Colaborador"){ ?>  <h6 class="collapse-header">REGISTRO</h6>
                          <a class="collapse-item" href="PerfilR">Registro Usuarios</a><?php } ?>
                    </div>
                </div>
            </li>
...
<!--                <img class="img-profile rounded-circle" src="https://source.unsplash.com/QAB-WJcbgJk/60x60">-->
                <img class="img-profile rounded-circle" src="Assets/img/crm.png">
              </a>
